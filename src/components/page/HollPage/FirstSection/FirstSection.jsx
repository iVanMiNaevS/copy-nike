      ...
      <div className={joinClasses("wrapper", "firstSect__wrapper")}>
        <div className="firstSect__content pt-40">
          <div className="firstSect__info">
            ...
            minus tenetur assumenda ex placeat cupiditate perferendis officia
            eius sapiente architecto iusto nostrum dicta omnis accusamus.
            Aspernatur perspiciatis quaerat corrupti?
          </div>

          <MyButtonLink to="/shoes" stylesOut="firstSect__button">
            WATCH SHOES
          </MyButtonLink>
        </div>
